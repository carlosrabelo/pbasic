...
MIPS PBasic interpreter written in assembly, running on SPIM and MARS simulators.
...
PBasic began in 2014 as a passion project during my Computer Science degree. Originally written in MIPS assembly to run on the MARS simulator, I built it to demonstrate to my classmates that assembly language could be used to build practical, fully functional software—like a complete BASIC interpreter—rather than just toy academic exercises.
